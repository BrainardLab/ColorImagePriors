function visBasis(basisSet, imgDim, basisSize)
% Visualization of RGB basis function
% 
% Syntax:
...
% 
% Inputs:
%   basisSet   - A matrix of basis functions of size [(imgDim * imgDim * 3), basisSize]
%   imgDim     - The linear dimensionality of original (square) RGB image 
...
% 
% Examples:
%   visBasisBW(basisSet, imgDim, basisSize)
% 
